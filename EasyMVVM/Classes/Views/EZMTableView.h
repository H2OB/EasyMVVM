...
/**
 ...
 @param cellBindingBlock 模式匹配成功时，该block被调#import <EasyMVVM/EZMBinder.h>
 */
...
@interface EZMTableView<__covariant SectionVM: id, __covariant CellVM: id> : UIView

@property (nonatomic, readonly, strong) EZRMutableNode<EZMContainer<SectionVM> *> *data;
