...
@interface EZMGridView<__covariant VM: id> : EZMContainerView  <EZMCubePresentation>
...
@property (nonatomic, readonly, strong) EZRMutableNode<NSNumber *> *column;
@property (nonatomic, readonly, strong) EZRMutableNode<NSNumber *> *itemHeight;
