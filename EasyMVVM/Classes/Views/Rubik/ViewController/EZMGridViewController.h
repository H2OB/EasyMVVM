...
@interface EZMGridViewController<__covariant VM: id> : EZMViewController <EZMCubePresentationPrivoder>

@property (nonatomic, readonly, strong) EZMGridView<VM> *gridView;
