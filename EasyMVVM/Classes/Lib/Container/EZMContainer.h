...
/*TODO:
@property (nonatomic, readonly, strong) EZRMutableNode<NSArray<T> *> *array;
//*/
- (instancetype)initWithArray:(nullable NSArray<T> *)array NS_DESIGNATED_INITIALIZER;
