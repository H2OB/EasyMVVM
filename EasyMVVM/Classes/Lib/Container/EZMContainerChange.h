...
@property (nonatomic, readonly, copy, nullable) NSArray<__kindof EZMContainerChange *> *changes;

+ (instancetype)transactionChangeWithChanges:(NSArray<EZMContainerChange *> *)changes;
...
//EZMContainerChange
//                EZMContainerFlushChange
//                EZMContainerMoveChange
//                EZMContainerTransactionChange
//                EZMContainerIndexedChange:
