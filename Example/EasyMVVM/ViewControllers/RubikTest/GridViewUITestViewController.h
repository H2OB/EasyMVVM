...
@interface GridViewUITestViewController : UIViewController
...
@property (nonatomic, weak) IBOutlet UIButton *increaseColumnButton;
@property (nonatomic, weak) IBOutlet UIButton *decreaseColumnButton;
@property (nonatomic, weak) IBOutlet UIButton *increaseItemHeightButton;
@property (nonatomic, weak) IBOutlet UIButton *decreaseItemHeightButton;
